...
public class MeteorBlocks {
	...
	public static final Block METEOR = new MeteorBlock().setRegistryName("Meteor").setBlockTextureName("Meteor");
	public static final Block HOT_METEOR = new HotMeteorBlock().setRegistryName("HotMeteor");
	public static final Block RARE_METEOR = new RareFallenMeteorBlock().setRegistryName("Meteor").setRegistryName("MeteorRare").setCreativeTab(null);
	public static final Block HOT_RARE_METEOR = new RareFallenHotMeteorBlock().setRegistryName("HotRareMeteor").setCreativeTab(null);
	public static final Block FREEZARITE = new FreezariteBlock().setRegistryName("Frezarite").setBlockTextureName("Frezarite");
	public static final Block KRENKONITE = new KreknoriteBlock().setRegistryName("Kreknorite").setBlockTextureName("Kreknorite");
	...
	public static final Block METEOR_SHIELD = new MeteorShieldBlock().setRegistryName("MeteorShield").setBlockTextureName("Meteor");
	public static final Block METEOR_SHIELD_TORCH = new MeteorShieldTorchBlock(true).setRegistryName("ProtectedLandTester").setBlockTextureName("ProtectedLandTester").setCreativeTab(MeteorsMod.meteorTab);
	public static final Block METEOR_SHIELD_TORCH_INACTIVE = new MeteorShieldTorchBlock(false).setRegistryName("ProtectedLandTester").setBlockTextureName("ProtectedLandTester").setCreativeTab(MeteorsMod.meteorTab);
	public static final Block METEOR_TIMER = new MeteorTimerBlock().setRegistryName("MeteorTimer").setBlockTextureName("MeteorTimer");
	public static final Block RED_METEOR_GEM = new RedMeteorGemBlock().setRegistryName("blockRedGem").setBlockTextureName("blockRedGem");
	...
	public static final Block FREEZER = new FreezingMachineBlock().setRegistryName("freezingMachine").setHardness(3.5F).setStepSound(Block.soundTypeMetal);
