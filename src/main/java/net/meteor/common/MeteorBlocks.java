...
public class MeteorBlocks {
	...
	public static final Block blockMeteor 				= new BlockMeteor().setRegistryName("Meteor").setBlockTextureName("Meteor").setHardness(10F).setResistance(200F).setStepSound(Block.soundTypeStone).setLightLevel(0.5F);
	public static final Block blockMeteorOre			= new BlockMeteorOre(MeteorItems.itemMeteorChips).setRegistryName("MeteorOre").setBlockTextureName("MeteorOre").setHardness(10F).setResistance(200F).setStepSound(Block.soundTypeStone);
	public static final Block blockFrezariteOre			= new BlockMeteorOre(MeteorItems.itemFrezaCrystal).setRegistryName("FrezariteOre").setBlockTextureName("frezarite_ore").setHardness(10F).setResistance(200F).setStepSound(Block.soundTypeStone);
	public static final Block blockRareMeteor			= new BlockRareFallenMeteor().setRegistryName("Meteor").setBlockTextureName("MeteorRare").setHardness(10F).setResistance(200F).setStepSound(Block.soundTypeStone).setLightLevel(0.5F).setCreativeTab(null);
	public static final Block blockMeteorShield			= new BlockMeteorShield().setRegistryName("MeteorShield").setBlockTextureName("Meteor").setHardness(2.5F).setStepSound(Block.soundTypeStone).setLightLevel(0.5F);
	public static final Block blockFrezarite			= new BlockFrezarite().setRegistryName("Frezarite").setBlockTextureName("Frezarite").setHardness(8.5F).setResistance(150F).setStepSound(Block.soundTypeGlass).setLightLevel(0.25F);
	public static final Block blockKreknorite 			= new BlockKreknorite().setRegistryName("Kreknorite").setBlockTextureName("Kreknorite").setHardness(11F).setResistance(350F).setStepSound(Block.soundTypeStone).setLightLevel(0.7F);
