...
public class HandlerAchievement
{
	...
	public static final Achievement shieldCrafted = new AchievementMeteorsMod("metShieldCrafted", "shieldCrafted", -2, 2, MeteorBlocks.METEOR_SHIELD, materialGather).registerStat();
	...
	public static final Achievement meteorBlocked = new AchievementMeteorsMod("metMeteorBlocked", "meteorBlocked", -3, 4, MeteorBlocks.METEOR_SHIELD_TORCH, shieldCrafted).registerStat();
	...
	public static final Achievement foundMeteor = new AchievementMeteorsMod("metFoundMeteor", "foundMeteor", 2, -2, new ItemStack(MeteorBlocks.METEOR, 1, 1), craftedDetector).registerStat();
	public static final Achievement craftedMeteorTimer = new AchievementMeteorsMod("metCraftedMeteorTimer", "craftedMeteorTimer", 2, -4, MeteorBlocks.METEOR_TIMER, craftedDetector).registerStat();
	...
	public static final Achievement craftedFreezer = new AchievementMeteorsMod("metFreezerCrafted", "freezerCrafted", 3, 3, MeteorBlocks.FREEZER, materialGather).registerStat();
